...
data1 = readtable('data.txt', 'Format', '%s %f %s %s', 'Delimiter', ',');
...
start_idx = 10000; % Start index
end_idx = start_idx + 2000;   % End index
...
plot(x, values3_limited, '-', 'DisplayName', 'Trained Predicted Data', 'LineWidth', lw, 'Color', '#EDB120'); % Plot the third dataset
hold off;
...
legend('Actual Data', 'Trained Predicted Data');
grid on;

% Save the plot if needed
saveas(gcf, sprintf('comparison_plot_%d_to_%d_two_datasets.png', start_idx, end_idx));